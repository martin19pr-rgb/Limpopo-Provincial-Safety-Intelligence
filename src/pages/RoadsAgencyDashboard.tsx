...
const maintenanceCrew = [
  ...
  { id: 'C-002', name: 'Road Crew Bravo', location: 'A2 Bridge Approach', task: 'Flood barrier', eta: '15 min', status: 'en route' },
  { id: 'C-003', name: 'Road Crew Charlie', location: 'A1 KM 22', task: 'Crack sealing', eta: 'On site', status: 'active' },
  { id: 'C-004', name: 'Inspection Unit 1', location: 'A2 Semonkong Pass', task: 'Erosion survey', eta: '22 min', status: 'en route' },
];
