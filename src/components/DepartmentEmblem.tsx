...
const emblemConfig: Record<string, {
  ...
  premier: {
    icon: Building2,
    name: 'PREMIER',
    motto: "Office of the Premier — Limpopo",
  ...
  saps: {
    icon: Radio,
    name: 'SAPS',
    motto: 'To Protect & Serve — Limpopo',
  ...
  electricity: {
    icon: Zap,
    name: 'ESKOM',
    motto: 'Eskom — Limpopo Grid Command',
  ...
  fire: {
    icon: Flame,
    name: 'LFRS',
    motto: 'Limpopo Fire & Rescue Service',
