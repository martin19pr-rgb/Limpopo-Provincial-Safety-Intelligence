...
const aiRemarks = [
  { text: "🚨 High crash probability detected on N1 KM 12 — dispatching nearest SAPS unit.", type: "alert" as const },
  ...
  { text: "🔵 SAPS Unit 34 repositioned to Polokwane CBD Market — PoW score: 1,240 pts.", type: "dispatch" as const },
